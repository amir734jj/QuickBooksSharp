...
namespace QuickBooksSharp.GraphQL.Services
{
    public interface IPayrollCompensationService
    {
        ...
        /// </summary>
        Task<GraphQLResponse<EmployeeCompensationsQueryData>> GetEmployeeCompensationsAsync(EmployeeCompensationsFilter filter, int? first = null, string? after = null, string? fields = null);
    }
}
